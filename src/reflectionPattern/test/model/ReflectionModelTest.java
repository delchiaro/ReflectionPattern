...
public class ReflectionModelTest {
    ...
    public void testTypeEquals()
    {
        ...
        // Same values, and Relationships again (reflectionPattern.test transitive property).
                                        ...
                                        CompositeFact.IllegalFactTypeException
    {
       ...
       // assertEquals( compTypeB, compType2B);
        ...
        /* NB
            Ho capito un problema che affliggeva questo reflectionPattern.test: quando aggiungo un oggetto in una HashSet, esso verrá indicizzato
            ...
            Questo problema affliggeva il reflectionPattern.test:
                    assertTrue( compositeFactB   .equals( compositeFact2B   ));
            e simili.
            ...
            La stessa cosa vale per il QuantitativeType e le Strategy legali.
    ...
    public void testModelBasic2(){
        ...
        try{
            ...
            //e.printStackTrace();
            assertTrue(true); // devo arrivare qua poiché il psi non è una Strategy consentita da bpmType.
        }
